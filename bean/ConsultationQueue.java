...
public class ConsultationQueue {
    ...
    public ConsultationQueue(Doctor doctor, Patient patient, ConsultationStatus consultationStatus, Timestamp scheduledTime) {
        this.doctor = doctor;
    ...
    public String toString() {
        return "ConsultationQueue{id=" + id + ", doctor=" + doctor.getId() + ", patient=" + patient.getId() + ", consultationStatus=" + consultationStatus + ", scheduledTime=" + scheduledTime + "}";
    }
